    ...
    return (
        <><div>
            ...
            <div className="bg-hero bg-no-repeat bg-cover">
                <header>
                    <nav className="border-black-200 px-4 lg:px-6 py-2.5 dark:bg-black-800">
                        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                            <a href="https://flowbite.com" className="flex items-center">
                                <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                                <span className="self-center text-white text-xl font-semibold whitespace-nowrap dark:text-white">Portfolio</span>
                            </a>
                            <div className="flex items-center lg:order-2">
                                <a href="Resume.pdf" download="Resume.pdf" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" >Get Resume</a>
                            ...
                            <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                                <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                                    ...
                                    <li>
                                        <a href="#" className="block py-2 pr-4 pl-3 text-white border-b border-white-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">About Us</a>
                                    </li>
                                    <li>
                ...
                <section className=" dark:bg-gray-900">
                    <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-8 lg:grid-cols-12">
                        <div className="mr-auto place-self-center lg:col-span-7">
                            ...
                            <div class="flex flex-wrap mb-4 mr-20 justify-center gap-6">
                            ...
                            <h1 className="max-w-2xl mb-4 text-4xl text-white font-extrabold leading-none md:text-5xl xl:text-5xl dark:text-white">I am Syed Masharib Shah</h1>
                            <p className="max-w-2xl mb-6 font-light text-white lg:mb-8 md:text-lg lg:text-3xl dark:text-gray-400">i'm Syed Masharib Shah, professional web developer with long time experience in this field​</p>
                            <a href="Resume.pdf" download="Resume.pdf" className="inline-flex items-center justify-center px-5 py-3 mr-7 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                                Get Resume
                            ...
                            <a href=''>
                                ...
                                <svg className="w-12 h-12 inline-flex text-center text-red-600 mb-3" viewBox="0 0 17 19" fill="currentColor">
                        ...
                        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                            <img src="/image/pic.png" alt="mockup" />
                        </div>
                    </div>
                </section>
            </div>
